...
<head>
    ...
    <title>SummerHill Liquor | Register</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}?v=24.1">
...
T4B1X5, Canada</p>
    ...
    <!-- Registration Form Section with Local Background Image -->
        ...
        <div class="form-container" data-aos="zoom-in" data-aos-duration="800" style="position: relative; z-index: 2;">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group-custom password-wrapper">
                    ...
                    <input type="password" name="password_confirmation" class="form-control" placeholder="Confirm Password" id="confirmPassword" required>
